defmodule NovySite.LiveHelpers do
  ...
  @doc """
  Renders a component inside the `NovySite.ModalComponent` component.
  ...
  ## Examples
      ...
      <%= live_modal @socket, NovySite.AuthProviderLive.FormComponent,
  ...
  def live_modal(_socket, component, opts) do
    ...
    live_component(socket, NovySite.ModalComponent, modal_opts)
  end
